...
export default function Feedback(){
  ...
  if(sent)return <section className="state"><p className="kicker">FEEDBACK RECEIVED</p><h1>Thank you for helping improve the hub.</h1><p>Your written response stays private. Only combined ratings and response totals may appear on the impact page.</p><div className="actions"><Link className="button" to="/opportunities">Browse opportunities</Link><Link className="button secondary" to="/impact">View impact</Link></div></section>;
